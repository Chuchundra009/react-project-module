    ...
    return (
        <tbody>
            ...
            <td className='tlistwords__list-btns'>
                    <button className='tlistwords__list-btnedit' onClick={closeRow}><img className='tlistwords__list-img' src={r} alt="" /></button>

                    <button className='tlistwords__list-btndel' onClick={()=> delWords(id)}><img className='tlistwords__list-img' src={d} alt="" /></button>
